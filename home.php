...
<body>
          ...
          <section>
              <div id="carouselExampleIndicators" class="carousel fonte-texto" data-interval="6000"
                  ...
                  <div class="carousel-inner">
                      <div class="carousel-item active">
                          <img class="d-block w-100 imagem-carrossel" src="./src/assets/slack_Slide1.JPG" alt="Primeiro Slide">
                          <div class="carousel-caption d-none d-md-block"></div>                                          </div>
                        <div class="carousel-item">
                          <img class="d-flex w-100 imagem-carrossel" src="./src/assets/trello_Slide21.JPG" alt="Segundo Slide">
                          <div class="carousel-caption d-none d-md-block"></div>
                      </div>
                      <div class="carousel-item">
                          <img class="d-block w-100 imagem-carrossel" src="./src/assets/googleDrive_Slide41.JPG" alt="Terceiro Slide">
                          <div class="carousel-caption d-none d-md-block"></div>
                     </div>
                      <div class="carousel-item">
                        <img class="d-block w-100 imagem-carrossel" src="./src/assets/googleAgenda_Slide31.JPG" alt="Terceiro Slide">
                        <div class="carousel-caption d-none d-md-block"></div>                      
                    </div>                    
                  </div>
              ...
              <article>
                  ...
                  <p class="text-center fonte-texto pb-5">
                    ...
                    Podem encontrar dificuldade em colocar em práticas ações para que tudo possa acontecer conforme o planejado.
                    Foi pensando nisso que trouxemos algumas opções de ferramentas que auxilam na gestão de projetos.
                    São tecnologias alternativas com recursos de gestão e que trazem resultados.                 
                    Aqui neste conteúdo, vais conhecer uma lista de 4 ferramentas para gestão de projetos.
                    Cada uma com uma função específica, que vai de encontro com as diferentes realidades que podem existir no seu dia a dia!
                </p>
              </article>
          </section>
      </main>
  ...
  <footer class="container-fluid pt-5">
      ...
      <div class="text-center pt-1">
          <p>Copyrigth @ Jaqueline Botelho at Cinel <time datetime="2020">2020</time></p>  
      </div>
  </footer>
